...
class EmployeeStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'place_of_birth_id'     => ['required', 'integer', 'exists:cities,code'],
            ...
            'residential_area_id'   => ['required', 'integer', 'exists:cities,code'],
            ...
            'salary_type'           => ['required', 'string', 'in:monthly,daily'],
